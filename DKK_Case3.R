...
tdm = TermDocumentMatrix(mach_corpus,
                         control = list(removePunctuation = TRUE,
                                        stopwords = c("risico", "risicos", "risk", "risks", "pagina", "alinea", "definitie",stopwords("dutch"), stopwords("en")),
...
# plot wordcloud
wordcloud(dm$word, dm$freq, scale = c(2, 0.2), random.order=FALSE, colors=brewer.pal(8, "Dark2"))
